...
const DangerZone = () => {
  ...
  const handleResetApp = async () => {
    Alert.alert(
      "Reset App",
      "⚠️ This will delete ALL your goals permanently. This action cannot be undone.",
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert(
                "App Reset",
                `Successfully deleted ${result.deletedCount} goal${result.deletedCount === 1 ? "" : "s"}. Your app has been reset.`
              );
            } catch (error) {
